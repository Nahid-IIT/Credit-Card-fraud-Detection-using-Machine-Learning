...
\titlepage{Credit Card Fraud Detection Using Machine Learning}{ Md. Shakil Hossain (Exam Roll: 192340, Class Roll: 2023)\\ 
Mahabubur Rahman (Exam Roll: 192341, Class Roll: 2024)\\
Nahidul Islam (Exam Roll: 192345, Class Roll: 2028)}{Professional Masters in Information Technology}
{Information Technology}{October, 2023}
{\textbf{Md. Mahmudur Rahman} \\Lecturer\\
...
\textbf{CCFD}  & Credit Card Fraud Detection \\
\textbf{KNN}  & K- Nearest Neighbors\\
\textbf{SVM}  &  Support Vector Machine\\
\textbf{L.R.}  &  Logistic Regression\\
...
\listoffigures   % Required if there is more than one figure     % Required if there is more than one table
...
%Chapter{Methodology}
\input{Chap5/Chapter5.tex}


%\chapter{Conclusion and Future Work}
\input{Chap7/Chapter7.tex}
